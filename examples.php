...
require_once("includes/ImportActiveCampaign.php");
...
<p><b>Note</b>: It can also be helpful to check our <a href="http://www.activecampaign.com/api/overview.php">API
        documentation</a> for the HTTP method that should be used for a particular endpoint as it can affect the format
    of your request.</p>
<p>Example:
