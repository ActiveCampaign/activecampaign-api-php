...
if ( !defined("API_URL") || (!defined("API_KEY") && !defined("API_USER") && !defined("API_PASS")) ) {
	require_once(dirname(__FILE__) . "/config.php");
}

require_once("Connector.class.php");

class Em extends EM_Connector {
	...
	function __construct($url, $api_key, $api_user = "", $api_pass = "") {
		...
		EM_Connector::__construct($url, $api_key, $api_user, $api_pass);
	}
	...
	function api($path, $post_data = array()) {
		...
		$add_tracking = false;
		if ($class == "EM_Tracking") $add_tracking = true;
