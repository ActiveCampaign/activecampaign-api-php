...
You can install **activecampaign-api-php** by cloning the source and switching to the "onsite" branch.
...
<pre>
define("ACTIVECAMPAIGN_URL", "http://localhost/activecampaign");
